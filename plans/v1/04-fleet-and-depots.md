...
- **Interface and player experience (07):** now written. The catalogue, owned trains, depots and sidings live in a near-full-screen Fleet workspace, which is also where rolling stock is assigned to schedules — this plan's *duties*, renamed there. Usable siding length is shown against drawn length as this plan requires. Named assignment failures surface both inline in Fleet and in the persistent bottom-bar status region.
